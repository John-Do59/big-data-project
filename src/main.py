...
def print_kpis(kpis: dict):
    ...
    kpis["revenue_by_state"].show(10, truncate=False)

    print("\n--- Nombre de commandes par État ---")
    kpis["orders_by_state"].show(10, truncate=False)

    print("\n--- Panier moyen par État ---")
    kpis["avg_basket_by_state"].show(10, truncate=False)
